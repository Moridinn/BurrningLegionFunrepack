...
function AmaniLookOut_OnCombat(Unit,event,pmisc)
	...
	Unit:CreateWaypoint(4,284.307404,1379.991211,49.321771,Unit:GetO(),0,256,0)
	Unit:RegisterEvent("AmaniLookOut_Waypoints",500,1)
...
function AmaniTempest_AIUpdate(Unit)
	...
	--print("The number of warriors is/are "..tostring(warcount))
	--print("The number of eagles is/are "..tostring(eaglecount))
...
function AmaniWarrior_OnSpawn(Unit)
	...
	Unit:ModifySpeed(12)
	if allowtempest == true then
		Unit:CreateWaypoint(1,229.025361+(math.random(3)*math.cos(math.random(20,60))),1465.758911+(math.random(3)*math.sin(math.random(20,60))),25.916751,Unit:GetO(),0,256,0)
		Unit:CreateWaypoint(2,228.005325+(math.random(3)*math.cos(math.random(20,60))),1435.453491+(math.random(3)*math.sin(math.random(20,60))),26.726126,Unit:GetO(),0,256,0)
		Unit:CreateWaypoint(3,228.352188+(math.random(3)*math.cos(math.random(20,60))),1374.711426+(math.random(3)*math.sin(math.random(20,60))),46.888203,Unit:GetO(),0,256,0)
		Unit:CreateWaypoint(4,284.307404+(math.random(3)*math.cos(math.random(20,60))),1379.991211+(math.random(3)*math.sin(math.random(20,60))),49.321771,Unit:GetO(),0,256,0)
		Unit:MoveToWaypoint(1)
...
function AmaniEagle_OnSpawn(Unit)
	...
	if allowtempest == true then
		Unit:ModifySpeed(20)
		Unit:CreateWaypoint(1,284.307404+(math.random(3)*math.cos(math.random(20,60))),1379.991211+(math.random(3)*math.sin(math.random(20,60))),49.321771,Unit:GetO(),0,256,0)
		Unit:CreateWaypoint(2,228.352188+(math.random(3)*math.cos(math.random(20,60))),1374.711426+(math.random(3)*math.sin(math.random(20,60))),46.888203,Unit:GetO(),0,256,0)
		Unit:CreateWaypoint(3,228.005325+(math.random(3)*math.cos(math.random(20,60))),1435.453491+(math.random(3)*math.sin(math.random(20,60))),26.726126,Unit:GetO(),0,256,0)
		Unit:CreateWaypoint(4,229.025361+(math.random(3)*math.cos(math.random(20,60))),1465.758911+(math.random(3)*math.sin(math.random(20,60))),25.916751,Unit:GetO(),0,256,0)
		Unit:MoveToWaypoint(1)
		Unit:DisableRespawn(1)
	end
end
...
function AmaniProtector_Abilities(Unit)
	...
	elseif math.random(3) == 2 and type(tank) == "userdata" and tank:IsAlive() == true then
		if Unit:IsAlive() == true then
			Unit:FullCastSpellOnTarget(43539, tank)
		end
