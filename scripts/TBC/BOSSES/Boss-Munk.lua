...
RegisterUnitEvent(199920, 1, "Munk_OnCombat")
RegisterUnitEvent(199920, 2, "Munk_OnLeaveCombat")
RegisterUnitEvent(199920, 3, "Munk_OnKilledTarget")
RegisterUnitEvent(199920, 4, "Munk_OnDied")