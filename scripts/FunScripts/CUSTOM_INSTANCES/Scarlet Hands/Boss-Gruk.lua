...
RegisterUnitEvent(2527115, 1, "Gruk_OnCombat")
RegisterUnitEvent(2527115, 2, "Gruk_OnLeaveCombat")
RegisterUnitEvent(2527115, 3, "Gruk_OnKilledTarget")
RegisterUnitEvent(2527115, 4, "Gruk_OnDied")